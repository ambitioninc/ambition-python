...
.. _ambitioninc repository: https://github.com/ambitioninc/ambition/issues
...
To get the source source code and run the unit tests, run::
    ...
    $ git clone git://github.com/ambitioninc/ambition.git
    $ cd ambition
    $ virtualenv env
    $ . env/bin/activate
    $ pip install nose
...
.. code-block:: python
    ...
    from ambition.version import __version__
...
* Bump version in ambition/version.py
